...
export function HomeSections() {
  return <>
    ...
    <section className="section bg-[#F5F5F5]"><div className="container grid items-center gap-10 lg:grid-cols-2"><Image src="/images/hero-vehicle.svg" width={800} height={450} alt="Original stylized dark vehicle illustration" className="rounded-2xl" /><div><h2 className="font-heading text-4xl font-black">Why Check a Vehicle Identification Number?</h2><p className="mt-5 leading-7 text-[#666]">Vehicle identification details can help connect a vehicle to available specifications and recorded events. Depending on the vehicle and location, a report may include registration information, accidents, mileage history, theft records, damage indicators and safety recalls. Not every data point is guaranteed to be available.</p></div></div></section>
